package com.modern.modernBE.controller;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.modern.modernBE.model.*;
import com.modern.modernBE.service.StudentService;
...
import static com.modern.modernBE.util.FPS.FPSBuilder.aFPS;
import static com.modern.modernBE.util.FPSCondition.FPSConditionBuilder.aFPSCondition;
import static com.modern.modernBE.util.FPSField.FPSFieldBuilder.aFPSField;
import static com.modern.modernBE.util.Strings.likeLowerOrNull;
...
public class StudentsController {
    ...
    {
        return new ResponseEntity<>(studentService.getStudentWithSatHigherThan(sat), HttpStatus.CREATED);
    }
}